...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(15);
    ...
    SBE_NODISCARD static const char *price_levelMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t price_levelId() SBE_NOEXCEPT
    {
        return 2;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t price_levelSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool price_levelInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t price_levelEncodingOffset() SBE_NOEXCEPT
    {
        return 1;
    }
    ...
    L2Data &quantity(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 7, sizeof(std::int64_t));
    ...
    L2Data &sequenceId(const std::int64_t value) SBE_NOEXCEPT
    {
        ...
        std::memcpy(m_buffer + m_offset + 7, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    std::basic_ostream<CharT, Traits> &builder, const L2Data &_writer)
{
    ...
    builder << ", ";
    builder << R"("price_level": )";
    builder << +writer.price_level();
